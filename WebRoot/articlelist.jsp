					...
					<div class="boxcontainer">
						<s:if test="#session.articlelist[0].title!=''">
							<div class="box left pos1">
								<a class="bot"
									href="article.action?article.id=<s:property value="#session.articlelist[0].id"/>"
						...
						<s:if test="#session.articlelist[2].title!=''">
							<div class="box left pos1">
								<a class="bot"
									href="article.action?article.id=<s:property value="#session.articlelist[2].id"/>"
									target=_self> <s:property
						...
						<s:if test="#session.articlelist[4].title!=''">
							...
							<div class="box left pos1">
								<a class="bot"
									href="article.action?article.id=<s:property value="#session.articlelist[4].id"/>"
									target=_self> <s:property
					...
					<div class="boxcontainer">
						<s:if test="#session.articlelist[1].title!=''">
							<div class="box right pos2">
								<div class="type"></div>
								<a class="bot"
									href="article.action?article.id=<s:property value="#session.articlelist[1].id"/>"
									target=_self> <s:property
						...
						<s:if test="#session.articlelist[3].title!=''">
							<div class="box right pos2">
								<div class="type"></div>
								<a class="bot"
									href="article.action?article.id=<s:property value="#session.articlelist[3].id"/>"
									target=_self> <s:property
						...
						<s:if test="#session.articlelist[5].title!=''">
							<div class="box right pos2">
								<div class="type"></div>
								<a class="bot"
									href="article.action?article.id=<s:property value="#session.articlelist[5].id"/>"
									target=_self> <s:property
